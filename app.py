...
<div class="hero-wrap">
  ...
  <div class="hero-stats">
    <div><div class="hero-stat-num">98.2%</div><div class="hero-stat-lbl">AI Model Accuracy</div></div>
...
with col_nav1:
    ...
    """, unsafe_allow_html=True)
    st.write("") 
    if st.button("เปิดโมดูล AI Detection ➔", key="btn_go_ai", use_container_width=True):
...
with col_nav2:
    ...
    """, unsafe_allow_html=True)
    st.write("")
    if st.button("เข้าสู่คลังความรู้ ค้นหาข้อมูล ➔", key="btn_go_know", use_container_width=True):
